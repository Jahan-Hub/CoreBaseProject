...
{
    public class ActionRepository : BaseRepository<Model.Models.MasterSettings.AccessControl.Action>, IActionRepository
    {
        public ActionRepository(DatabaseContext databaseContext) : base(databaseContext) { }

        public override async Task<ICollection<Model.Models.MasterSettings.AccessControl.Action>> GetAllAsync()
        {
        ...
        public async Task<PaginatedResponse<Model.Models.MasterSettings.AccessControl.Action>> GetActionsFilterAsync(PaginationRequest paginationRequest, CancellationToken cancellationToken = default)
        {
            // Get actions
            ...
            // Apply sorting
            var sortableColumns = new Dictionary<string, Expression<Func<Model.Models.MasterSettings.AccessControl.Action, object>>>(StringComparer.OrdinalIgnoreCase)
            {
                ["name"] = u => u.Name,
                ["id"] = u => u.Id
            };
            ...
            var paginatedResponse = new PaginatedResponse<Model.Models.MasterSettings.AccessControl.Action>
            {
                Data = result,
        ...
        public override async Task<Model.Models.MasterSettings.AccessControl.Action?> GetByIdAsync(int id)
        {
        ...
        public async Task<Model.Models.MasterSettings.AccessControl.Action?> GetActionByName(string name)
        {
            var action = await dbContext.Actions
