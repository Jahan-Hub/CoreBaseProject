using CoreBaseProject.Application.ApplicationLogic.MasterSettings.ModuleLogic.Command;
using CoreBaseProject.Application.ApplicationLogic.MasterSettings.ModuleLogic.Model;
...
namespace CoreBaseProject.Api.Controllers.MasterSettings
{
    public class ModuleController : BaseController
    {
        ...
        public async Task<ActionResult<ModuleViewModel>> GetByIdAsync(string id)
        {
            ...
            // Select list
            moduleViewModel.OptionsDataSources.StatusSelectList = Mediator.Send(new GetEnumTypeCollectionQuery { EnumTypeId = BaseEnumConfiguration.CoreBaseProject.GlobalStatus }).Result;
