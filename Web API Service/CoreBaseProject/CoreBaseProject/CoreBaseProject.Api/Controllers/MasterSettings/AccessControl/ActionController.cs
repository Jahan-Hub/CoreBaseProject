...
namespace CoreBaseProject.Api.Controllers.MasterSettings.AccessControl
{
    public class ActionController : BaseController
    {
        ...
        public async Task<ActionResult<ActionViewModel>> GetByIdAsync(string id)
        {
            ...
            // Select list
            actionViewModel.OptionsDataSources.StatusSelectList = Mediator.Send(new GetEnumTypeCollectionQuery { EnumTypeId = BaseEnumConfiguration.CoreBaseProject.GlobalStatus }).Result;
