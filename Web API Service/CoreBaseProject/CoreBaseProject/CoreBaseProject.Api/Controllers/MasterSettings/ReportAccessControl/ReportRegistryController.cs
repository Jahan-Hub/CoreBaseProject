using CoreBaseProject.Application.ApplicationLogic.MasterSettings.ModuleLogic.Queries;
using CoreBaseProject.Application.ApplicationLogic.MasterSettings.ReportAccessControl.ReportRegistryLogic.Command;
using CoreBaseProject.Application.ApplicationLogic.MasterSettings.ReportAccessControl.ReportRegistryLogic.Model;
using CoreBaseProject.Application.ApplicationLogic.MasterSettings.ReportAccessControl.ReportRegistryLogic.Queries;
using CoreBaseProject.Application.ApplicationShared.Queries;

namespace CoreBaseProject.Api.Controllers.MasterSettings.ReportAccessControl
{
    public class ReportRegistryController : BaseController
    {
        ...
        public async Task<ActionResult<ReportRegistryViewModel>> GetByIdAsync(int id)
        {
            ...
            reportRegistryViewModel.OptionsDataSources.StatusSelectList =
                await Mediator.Send(new GetEnumTypeCollectionQuery { EnumTypeId = BaseEnumConfiguration.CoreBaseProject.GlobalStatus });
