...
using CoreBaseProject.Application.ApplicationLogic.MasterSettings.CompanyLogic.Model;
...
namespace CoreBaseProject.Api.Controllers.MasterSettings
{
    public class CompanyController : BaseController
    {
        ...
        public async Task<ActionResult<CompanyViewModel>> GetByIdAsync(string id)
        {
            ...
            // Select list
            companyViewModel.OptionsDataSources.StatusSelectList = Mediator.Send(new GetEnumTypeCollectionQuery { EnumTypeId = BaseEnumConfiguration.CoreBaseProject.GlobalStatus }).Result;
