...
using CoreBaseProject.Application.ApplicationLogic.MasterSettings.FeaturesLogic.Model;
using CoreBaseProject.Application.ApplicationLogic.MasterSettings.FeaturesLogic.Queries;
...
namespace CoreBaseProject.Api.Controllers.MasterSettings
{
    public class FeatureController : BaseController
    {
        ...
        public async Task<ActionResult<FeaturesViewModel>> GetByIdAsync(string id)
        {
            ...
            featureViewModel.OptionsDataSources.StatusSelectList = Mediator.Send(new GetEnumTypeCollectionQuery { EnumTypeId = BaseEnumConfiguration.CoreBaseProject.GlobalStatus }).Result;
