...
namespace CoreBaseProject.Application.ApplicationLogic.MasterSettings.AccessControl.UserAccessMapping.Command
{
    public class CreateUserAccessMappingSeedCommand
    {
        ...
        {
            var userAccessMappingList = new List<CoreBaseProject.Model.Models.MasterSettings.AccessControl.UserAccessMapping>();
            var finalUserAccessMappingList = new List<CoreBaseProject.Model.Models.MasterSettings.AccessControl.UserAccessMapping>();
            ...
            foreach (var feature in features)
            {
                foreach (var action in actions)
                {
                    ...
                    new CoreBaseProject.Model.Models.MasterSettings.AccessControl.UserAccessMapping
                    {
