...
namespace CoreBaseProject.Application.ApplicationLogic.MasterSettings.AccessControl.FeatureActionMapping.Command
{
    public class CreateFeatureActionMappingSeedCommand
    {
        ...
        public async Task SeedAsync()
        {
            ...
            var finalFeatureActionMappings = new List<CoreBaseProject.Model.Models.MasterSettings.AccessControl.FeatureActionMapping>();
            var featureActionMappings = new List<CoreBaseProject.Model.Models.MasterSettings.AccessControl.FeatureActionMapping>();
            ...
            foreach (var feature in features)
            {
                foreach (var action in actions)
                {
                    ...
                    featureActionMappings.Add(new CoreBaseProject.Model.Models.MasterSettings.AccessControl.FeatureActionMapping
                    {
