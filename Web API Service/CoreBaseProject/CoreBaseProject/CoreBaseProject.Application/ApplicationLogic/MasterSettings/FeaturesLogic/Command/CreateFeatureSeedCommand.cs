namespace CoreBaseProject.Application.ApplicationLogic.MasterSettings.FeaturesLogic.Command
{
    public class CreateFeatureSeedCommand
    {
        ...
        // Create seed module
        private ICollection<CoreBaseProject.Model.Models.MasterSettings.Module> CreateModule()
        {
            return new List<CoreBaseProject.Model.Models.MasterSettings.Module>()
            {
                new CoreBaseProject.Model.Models.MasterSettings.Module { Code = "MS", Name = "Master Setting", 
                    StatusId = GlobalStatus.Active },
                new CoreBaseProject.Model.Models.MasterSettings.Module { Code = "EM", Name = "Expense Management", 
                    StatusId = GlobalStatus.Active },
                new CoreBaseProject.Model.Models.MasterSettings.Module { Code = "IM", Name = "Income Management", 
                    StatusId = GlobalStatus.Active },
                new CoreBaseProject.Model.Models.MasterSettings.Module { Code = "CBM", Name = "Cash Bank Management", 
                    StatusId = GlobalStatus.Active },
                new CoreBaseProject.Model.Models.MasterSettings.Module { Code = "RPT", Name = "Reports & Analytics", 
                    StatusId = GlobalStatus.Active },
            };
        }
        ...
        private ICollection<Feature> MasterSettings()
        {
            return new List<Feature>()
            {
                ...
                new Feature { Code = "Customer", Name = "Customer", ModuleId = 1, LinkedTableName = "Customers", LinkedControllerName = "Customer", StatusId = GlobalStatus.Active },
